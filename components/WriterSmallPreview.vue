        ...
        <div class="shrink-1">
          <nuxt-link :to="{name: 'writers-id', params: {id}}">
            <p class="text-2xl md:text-4xl leading-tight font-bold text-gray-600">
              <span>{{ name }}</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 md:h-8 md:w-8 ml-1 relative bottom-[2px] text-lime-500 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
