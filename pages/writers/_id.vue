...
export default {
  ...
  async fetch() {
    let apiURL = `https://dorianm.com/nuxt-recipes-api/writer.php?friendly_id=${this.$route.params.id}`;
  ...
  computed: {
    customUrl() {
      return `https://dorianm.com/nuxt-recipes-api/search.php?writer=${this.id}`
    },
    writerType() {
